...
(async () => {
  ...
  // このJavascriptクラスにはAssemblyScriptからエクスポートされる関数がすべて反映される
  let dVector2D = {
    // init関数はVector2Dのコンストラクタを呼び出す
    init: function (x, y) {
  ...
  // 関数をAssemblyScript Loaderから呼び出す
