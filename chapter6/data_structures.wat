(module
  ...
  (func $set_collision
    ...
    ;; obj_base_1 + collision_offsetに1(true)を格納
    ...
    (loop $outer_loop
      ...
      (loop $inner_loop 
        (block $inner_continue
          ...
          ;; $i_obj + $x_offsetを読み取り$xiに格納
          (call $get_attr (local.tee $i_obj) (global.get $x_offset))
          local.set $xi

          ;; $i_obj + $y_offsetを読み取り$yiに格納
